...
bool MASK0701::processApciMemoryReadPDU(const int addressStart, uint8_t* payLoad, const int lengthPayLoad)
{
...
bool MASK0701::processApciMemoryWritePDU(const int addressStart, uint8_t* payLoad, const int lengthPayLoad)
{
