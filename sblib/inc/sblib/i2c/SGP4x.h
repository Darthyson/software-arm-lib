...
private:
     ...
     */
    SGP4xResult readSensor(Sgp4xCommand command, uint8_t* commandBuffer, uint8_t commandBufferSize, uint8_t* readBuffer,
                           uint8_t readBufferSize, uint16_t processDelayMs);
