...
constexpr uint8_t BOOTLOADER_MINOR_VERSION = 21; //!< Bootloader minor version @note change also in BootloaderUpdater's app_main.cpp

constexpr uint8_t UPDATER_MIN_MAJOR_VERSION = 1;  //!< minimum required major version of the Selfbus Updater we are talking to
constexpr uint8_t UPDATER_MIN_MINOR_VERSION = 29; //!< minimum required minor version of the Selfbus Updater we are talking to
