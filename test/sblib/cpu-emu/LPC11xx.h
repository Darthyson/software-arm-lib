...
/******************************************************************************/
extern LPC_I2C_TypeDef      _LPC_I2C;
extern LPC_WDT_TypeDef      _LPC_WDT;
extern LPC_UART_TypeDef     _LPC_UART;
extern LPC_TMR_TypeDef      _LPC_TMR16B0;
extern LPC_TMR_TypeDef      _LPC_TMR16B1;
extern LPC_TMR_TypeDef      _LPC_TMR32B0;
extern LPC_TMR_TypeDef      _LPC_TMR32B1;
extern LPC_ADC_TypeDef      _LPC_ADC;
extern LPC_PMU_TypeDef      _LPC_PMU;
extern LPC_FLASHCTRL_Type   _LPC_FLASHCTRL;
extern LPC_SSP_TypeDef      _LPC_SSP0;
extern LPC_SSP_TypeDef      _LPC_SSP1;
extern LPC_CAN_TypeDef      _LPC_CAN;
extern LPC_IOCON_TypeDef    _LPC_IOCON;
extern LPC_SYSCON_TypeDef   _LPC_SYSCON;
extern LPC_GPIO_TypeDef     _LPC_GPIO0;
extern LPC_GPIO_TypeDef     _LPC_GPIO1;
extern LPC_GPIO_TypeDef     _LPC_GPIO2;
extern LPC_GPIO_TypeDef     _LPC_GPIO3;

#define LPC_I2C         ( & _LPC_I2C)
#define LPC_WDT         ( & _LPC_WDT)
#define LPC_UART        ( & _LPC_UART)
#define LPC_TMR16B0     ( & _LPC_TMR16B0)
#define LPC_TMR16B1     ( & _LPC_TMR16B1)
#define LPC_TMR32B0     ( & _LPC_TMR32B0)
#define LPC_TMR32B1     ( & _LPC_TMR32B1)
#define LPC_ADC         ( & _LPC_ADC)
#define LPC_PMU         ( & _LPC_PMU)
#define LPC_FLASHCTRL   ( & _LPC_FLASHCTRL)
#define LPC_SSP0        ( & _LPC_SSP0)
#define LPC_SSP1        ( & _LPC_SSP1)
#define LPC_CAN         ( & _LPC_CAN)
...
#define LPC_IOCON_BASE LPC_IOCON
