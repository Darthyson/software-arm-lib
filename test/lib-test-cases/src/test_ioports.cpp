...
TEST_CASE("PinModeFunc", "[ioports]")
{
    REQUIRE(PinModeFunc(PF_NONE) == 0x00000000);
    REQUIRE(PinModeFunc(PF_PIO) == 0x00040000);
    REQUIRE(PinModeFunc(PF_AD) == 0x00080000);
    REQUIRE(PinModeFunc(PF_RESET) == 0x000c0000);
    REQUIRE(PinModeFunc(PF_SWDIO) == 0x00100000);
    REQUIRE(PinModeFunc(PF_SWCLK) == 0x00140000);
    REQUIRE(PinModeFunc(PF_MAT) == 0x00180000);
    REQUIRE(PinModeFunc(PF_CAP) == 0x001c0000);
    REQUIRE(PinModeFunc(PF_CLKOUT) == 0x00200000);
    REQUIRE(PinModeFunc(PF_SDA) == 0x00240000);
    REQUIRE(PinModeFunc(PF_SCL) == 0x00280000);
    REQUIRE(PinModeFunc(PF_SSEL) == 0x002c0000);
    REQUIRE(PinModeFunc(PF_MISO) == 0x00300000);
    REQUIRE(PinModeFunc(PF_MOSI) == 0x00340000);
    REQUIRE(PinModeFunc(PF_SCK) == 0x00380000);
    REQUIRE(PinModeFunc(PF_RXD) == 0x003c0000);
    REQUIRE(PinModeFunc(PF_TXD) == 0x00400000);
    REQUIRE(PinModeFunc(PF_RTS) == 0x00440000);
    REQUIRE(PinModeFunc(PF_DTR) == 0x00480000);
    REQUIRE(PinModeFunc(PF_DSR) == 0x004c0000);
    REQUIRE(PinModeFunc(PF_CTS) == 0x00500000);
    REQUIRE(PinModeFunc(PF_DCD) == 0x00540000);
    REQUIRE(PinModeFunc(PF_RI) == 0x00580000);
    REQUIRE(PinModeFunc(PF_USBP) == 0x005c0000);
    REQUIRE(PinModeFunc(PF_USB_M) == 0x00600000);
    REQUIRE(PinModeFunc(PF_USB_VBUS) == 0x00640000);
    REQUIRE(PinModeFunc(PF_USB_CONNECT) == 0x00680000);
    REQUIRE(PinModeFunc(PF_USB_FTOGGLE) == 0x006c0000);
    REQUIRE(PinModeFunc(PF_ARM_TRACE_CLK) == 0x00700000);
    REQUIRE(PinModeFunc(PF_ARM_TRACE_SWV) == 0x00740000);
